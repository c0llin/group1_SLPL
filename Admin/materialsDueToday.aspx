...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:SqlDataSource ID="sdsMaterialsDueToday" runat="server" ConnectionString="<%$ ConnectionStrings:db_library %>" SelectCommand="SELECT * FROM [library_Rentals]"></asp:SqlDataSource>
    <asp:GridView ID="gvMaterialsDueToday" runat="server" AutoGenerateColumns="False" DataKeyNames="RentalID" DataSourceID="sdsMaterialsDueToday">
        <Columns>
